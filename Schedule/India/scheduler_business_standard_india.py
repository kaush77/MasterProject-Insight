...
import business_standard as loader
import schedule
...
# Global variables
market_hours_init = 0
lookup_value = "business_standard"  # search website name
...
def start_process():
    ...
    try:
        ...
        print("***********Initiate Process - business_standard**************")
        database_log.process_log("India - business_standard : start_process", "Initiate Process")
        ...
        while True:
            ...
            loader.start_load_process(lookup_value)
            database_log.process_log("India - business_standard : start_process", "Re-Run Process")

            print("Last run was successful for India - business_standard, next run in {} seconds.".format(scheduled_sleeping_seconds))
            time.sleep(scheduled_sleeping_seconds)


    except Exception as error:
        database_log.error_log("India - business_standard : start_process", error)
